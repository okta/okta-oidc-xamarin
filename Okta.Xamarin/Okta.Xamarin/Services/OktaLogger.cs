...
namespace Okta.Xamarin.Services
{
    ...
    public class OktaLogger : IOktaLogger
    {
		...
		{
			LogLoadStateStartedEvents();
			LogLoadStateCompletedEvents();
			LogLoadStateExceptionEvents();
			LogSecureStorageWriteStartedEvents();
			LogSecureStorageWriteCompletedEvents();
			LogSecureStorageWriteExceptionEvents();
			LogSecureStorageReadStartedEvents();
			LogSecureStorageReadCompletedEvents();
			LogSecureStorageReadExceptionEvents();
			LogRequestExceptionEvents();
			LogSignInStartedEvents();
			LogSignInCompletedEvents();
			LogSignOutStartedEvents();
			LogSignOutCompletedEvents();
			LogAuthenticationFailedEvents();
			LogRevokeStartedEvents();
			LogRevokeCompletedEvents();
			LogRevokeExceptionEvents();
			LogGetUserStartedEvents();
			LogGetUserCompletedEvents();
			LogIntrospectStartedEvents();
			LogIntrospectCompletedEvents();
			LogRenewStartedEvents();
			LogRenewCompletedEvents();
			LogRenewExceptionEvents();
		}
